   ...
   <script>console.log("Fetched literally ID: <?= $_SESSION['currentPage']; ?>");</script>
    ...
    <div class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="mwadmin.php" class="nav-item">
...
document.addEventListener('DOMContentLoaded', fetchApprovedAppointments);
                    ...
                    <div style="display: flex; justify-content: flex-end; align-items: center; margin-bottom: 8px;">
                        <div id="current-time" style="font-size: 1.2rem; color: #fff; background: linear-gradient(90deg, #F9DFDF 0%, #F5AFAF 100%); padding: 8px 22px; border-radius: 10px; font-weight: 500; box-shadow: 0 2px 8px rgba(118,75,162,0.08);"></div>
                    </div>
      ...
      <div id="patient-list-section" class="content-section" style="margin-top: 30px; display: none;">
          <h2 style="color: #DB8DD0; font-size: 2rem; font-weight: bold; margin-bottom: 24px; letter-spacing: 1px;">PATIENT LIST</h2>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (currentPage === "Medical Records") {
    ...
    if (patientList) patientList.style.display = 'none';
    if (medRecords) medRecords.style.display = 'none';
    const homeTab = Array.from(document.querySelectorAll('.nav-item')).find(nav =>
      nav.textContent.trim().includes('Home')
    );
    if (homeTab) {
      document.querySelectorAll('.nav-item').forEach(nav => nav.classList.remove('active'));
...
<!-- Settings Section (hidden by default) -->
        ...
        <div id="medical-records-section" class="content-section" style="margin-top: 30px; display: none;">
            <h2 style="margin-bottom: 10px; color: #222;">Patient Medical Records</h2>
            <div style="width: 100%; padding: 0 24px; display: flex; flex-direction: column; gap: 24px; align-items: flex-start;">
                <!-- Patient Info Left -->
                 
                <div style="min-width: 320px; display: flex; flex-direction: column; gap: 24px;">
                    ...
                    <div style="padding: 16px 0; display: flex; flex-direction: column; gap: 24px;">
                        <div>
                            ...
                            <div class="info-item" style="display:inline-flex; gap:6px; align-items:center; padding:8px 12px; border:1px solid #e2e8f0; background:#f8fafc; border-radius:12px; margin:6px 6px 0 0;">
                            ...
                            <div class="info-item" style="display:inline-flex; gap:6px; align-items:center; padding:8px 12px; border:1px solid #e2e8f0; background:#f8fafc; border-radius:12px; margin:6px 6px 0 0;"><span class="info-label">Age:</span> 
                                <?= htmlspecialchars(PatientRecord::$age) ?> 
                            <span class="info-value"></span></div>

                            <div class="info-item" style="display:inline-flex; gap:6px; align-items:center; padding:8px 12px; border:1px solid #e2e8f0; background:#f8fafc; border-radius:12px; margin:6px 6px 0 0;"><span class="info-label">Gender:</span>
                              <span class="info-value">
                                <?= htmlspecialchars(PatientRecord::$gender) ?>
                             </span>
                            </div>
                            <div class="info-item" style="display:inline-flex; gap:6px; align-items:center; padding:8px 12px; border:1px solid #e2e8f0; background:#f8fafc; border-radius:12px; margin:6px 6px 0 0;"><span class="info-label">Status:</span>
                              <span class="info-value">
                                <?= htmlspecialchars(PatientRecord::$status) ?>
                              </span>
                            </div>
                            <div class="info-item" style="display:inline-flex; gap:6px; align-items:center; padding:8px 12px; border:1px solid #e2e8f0; background:#f8fafc; border-radius:12px; margin:6px 6px 0 0;"><span class="info-label">Contact Number:</span>
                             <span class="info-value">
                                <?= htmlspecialchars(PatientRecord::$contact) ?>
                             </span>
                            </div>
                            
                            <div class="info-item" style="display:inline-flex; gap:6px; align-items:center; padding:8px 12px; border:1px solid #e2e8f0; background:#f8fafc; border-radius:12px; margin:6px 6px 0 0;"><span class="info-label">Occupation:</span>
                            <span class="info-value">
                          ...
                          <div class="info-item" style="display:inline-flex; gap:6px; align-items:center; padding:8px 12px; border:1px solid #e2e8f0; background:#f8fafc; border-radius:12px; margin:6px 6px 0 0;"><span class="info-label">Name:</span>
                            <span class="info-value">
                                    <?= htmlspecialchars(PatientRecord::$gender) ?>
                            </span>
                          </div>
                ...
                <div style="width: 100%; display: flex; flex-direction: column; gap: 24px;">
                    <div style="display: block; width: 100%;">
                        <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 24px; margin-bottom: 32px;">
                            <!-- Search Medical Records Card -->
                             
                            <div style="flex: 1; min-width: 280px; padding: 8px 0; display: flex; flex-direction: column; gap: 16px;">
                                <h3 style="color: #232b3b; font-size: 20px; font-weight: 700; margin: 0;">Search Medical Records</h3>
                                
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                                    <select id="visitDateSelector" style="width: 100%; margin-bottom: 0; padding: 12px 16px; border-radius: 8px; border: 1.5px solid #e2e8f0; font-size: 15px; background: #fff; transition: border 0.2s; box-sizing: border-box;">
                                ...
                                <div style="margin-top: 8px; width: 100%;">
                                    <button type="button" class="btn-primary" id="searchVisitDateBtn" style="width: 100%; padding: 12px 16px; font-size: 15px; font-weight: 600; border-radius: 8px; background: linear-gradient(90deg, #667eea 0%, #764ba2 100%); color: white; border: none; cursor: pointer; transition: all 0.2s ease;">Search Visit Date</button>
  ...
  dateSelector.addEventListener('change', function () {
    if (this.value) {
      dateInput.value = this.value;
                            ...
                            <form id="pregnancy-tracker-form" style="flex: 1; min-width: 320px; padding: 8px 0; display: flex; align-items: center; gap: 16px;" method="POST">
                              ...
                              <div style="display: flex; flex-direction: column; gap: 10px; flex: 1;">
                                ...
                                <h3 style="color: #232b3b; font-size: 20px; font-weight: 700; margin: 0 0 4px;">Age of Gestation</h3>
                                <div>
                                ...
                                <div class="aog-bar">
                                  <div class="aog-bar-top">
                                    <span id="aogWeeks">0w</span>
                                    <span id="aogPercent">0%</span>
                                  </div>
                                  <div class="aog-bar-track">
                                    <div id="aogBarFill" class="aog-bar-fill"></div>
                                  </div>
                                </div>
                            ...
                            document.getElementById('lmpDate').addEventListener('input', function() { if (this.value) updateAOG(); });
                            const edcEl = document.getElementById('edcDate');
                            if (edcEl) {
                              edcEl.addEventListener('change', updateAOGFromEDC);
                              edcEl.addEventListener('input', function() { if (this.value) updateAOGFromEDC(); });
                            }
                            ...
                            function updateAOG() {
                              ...
                              const aogProgress = document.getElementById('aogProgress');
                              ...
                              if (!lmpDateStr) {
                                ...
                                if (aogProgress) aogProgress.style.strokeDashoffset = String(circumference);
                              ...
                              const aogDays = diffDays % 7;
                              if (aogDisplay) aogDisplay.textContent = `${Math.max(aogWeeks, 0)}w${aogDays > 0 ? ' ' + aogDays + 'd' : ''}`;
                              const progressPct = Math.min(Math.max((aogWeeks / 40) * 100, 0), 100);
                              if (aogProgress) {
                                const offset = circumference * (1 - progressPct / 100);
                                aogProgress.style.strokeDashoffset = String(offset);
                              }
                            ...
                            function updateAOGFromEDC() {
                              const edcInput = document.getElementById('edcDate');
                              const lmpInput = document.getElementById('lmpDate');
                              if (!edcInput || !edcInput.value) { updateAOG(); return; }
                              const edcDate = new Date(edcInput.value);
                              if (isNaN(edcDate.getTime())) { updateAOG(); return; }
                            ...
                            document.getElementById('pregnancy-tracker-form').addEventListener('submit', function(e) {
                              ...
                              .then(data => {
                                if (data.status === 'success') {
                                  ...
                                  updateAOG(); // Update the bar immediately with the current LMP
                                } else {
                            ...
                            document.addEventListener('DOMContentLoaded', updateAOG);
                            </script>
                        </div>
                    </div>
                </div>
            </div>
            <div class="baby-gallery-card" style="padding: 8px 0;">
              <div class="baby-gallery-header" style="text-align: center;">
                <h3 class="baby-gallery-title" style="text-align: center; margin: 0 auto;">Baby Profiles</h3>
              </div>
              <div id="babyMosaicGrid" class="baby-mosaic-grid"></div>
              <div id="babyProfilesMessage"></div>
              <script>
                document.addEventListener('DOMContentLoaded', function () {
                  const patientId = <?= json_encode(PatientRecord::$id) ?>;
                  const grid = document.getElementById('babyMosaicGrid');
                  const msg = document.getElementById('babyProfilesMessage');
                  msg.textContent = '';
                  grid.innerHTML = '';
                  if (!patientId) {
                    msg.textContent = 'No baby profile created';
                    return;
                  }
                  fetch('auth/action/staff/staff_get_patient_baby_profiles.php?patient_id=' + encodeURIComponent(patientId))
                    .then(res => res.json())
                    .then(data => {
                      ...
                      profiles.forEach(p => {
                        ...
                        a.href = 'docbbyprof.php?id=' + encodeURIComponent(p.id);
                        a.className = 'baby-card-link';
                        const item = document.createElement('div');
                        item.className = 'mosaic-item square';
                        if (p.photo_url) {
                          ...
                          item.style.background = '#f8f9fe';
                          item.style.display = 'flex';
                          item.style.alignItems = 'center';
                          item.style.justifyContent = 'center';
                          item.textContent = (p.name || 'Baby');
                        }
                        a.appendChild(item);
                        grid.appendChild(a);
                      });
            ...
            <form id="riskAssessmentForm" method="POST">
              ...
              <div style="padding: 8px 0; margin-bottom: 24px; width: 100%;">
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                                    <button type="button"  style="display: flex; align-items: center; gap: 8px; padding: 10px 16px; border-radius: 20px; border: 2px solid #cbd5e1 !important; background: #e5e7eb !important; color: #1f2937 !important; cursor: pointer; transition: all 0.3s ease; font-size: 14px; font-weight: 600;" class="selected">
                                        <span>⭕</span>
                                        <span>Not Set</span>
                                    </button>
                                    <button type="button"  style="display: flex; align-items: center; gap: 8px; padding: 10px 16px; border-radius: 20px; border: 2px solid #3b82f6 !important; background: #dbeafe !important; color: #1e40af !important; cursor: pointer; transition: all 0.3s ease; font-size: 14px; font-weight: 600;">
                                        <span>✅</span>
                                        <span>Low Risk</span>
                                    </button>
                                    <button type="button"  style="display: flex; align-items: center; gap: 8px; padding: 10px 16px; border-radius: 20px; border: 2px solid #ef4444 !important; background: #fee2e2 !important; color: #991b1b !important; cursor: pointer; transition: all 0.3s ease; font-size: 14px; font-weight: 600;">
                                        <span>⚠️</span>
                                        <span>High Risk</span>
                                    </button>
            </div>
...
<div id="physicalExamTab" class="medrec-tab active" style="background: none; border: none; font-size: 17px; font-weight: 700; color: #7c3aed; padding: 10px 0 12px 0; border-bottom: 3px solid #7c3aed; cursor: default; outline: none;">Patient Assessment</div>
                </div>
                </div>
                <div id="physicalExamContent" class="pa-summary pa-layout-cards">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; padding-bottom: 16px; border-bottom: 2px solid #e2e8f0;">
                    <h3 style="margin: 0; color: #6c336e; font-size: 22px; font-weight: 800; letter-spacing: 0.3px;">📋 Patient Assessment Summary</h3>
                    <div style="display:flex; gap:12px; align-items:center;">
                        <button type="button" class="btn-primary" id="physicalExamAddNewBtn" style="min-width: 140px; padding: 10px 20px; font-size: 14px; font-weight: 700; border-radius: 12px; box-shadow: 0 4px 14px rgba(102,126,234,0.3);" onclick="console.log('Physical Exam button clicked via inline onclick')"> + Add New</button>
                    </div>
                </div>
                <div class="pa-summary">
                    <!-- Physical Exam Summary Card -->
                    <div class="pa-summary-card large" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: 1px solid #e2e8f0; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); padding: 24px; transition: all 0.3s ease; position: relative; overflow: hidden; width: 100%;">
                        <div class="pa-collapse">
                            <div class="pa-collapse-header">
                                <div class="pa-collapse-title">Physical & Pelvic Examination</div>
                                <div class="pa-collapse-icon">›</div>
                            </div>
                            <div class="pa-collapse-content">
                        <!-- Main Body Systems -->
                        <div class="summary-section-group">
                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span class="summary-row-label">Conjunctiva</span>
                                <span id="summary-conjunctiva" class="summary-row-value">—</span>
                            </div>
                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span class="summary-row-label">Neck</span>
                                <span id="summary-neck" class="summary-row-value">—</span>
                            </div>
                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span class="summary-row-label">Thorax</span>
                                <span id="summary-thorax" class="summary-row-value">—</span>
                            </div>
                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span class="summary-row-label">Abdomen</span>
                                <span id="summary-abdomen" class="summary-row-value">—</span>
                            </div>
                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span class="summary-row-label">Extremities</span>
                                <span id="summary-extremities" class="summary-row-value">—</span>
                            </div>
                        </div>
                        
                        <!-- Breast Examination - Nested Collapse -->
                        <div class="pa-section-header" style="margin-top: 20px;">
                            <div class="pa-section-title">Breast Examination</div>
                        </div>
                        <div class="pa-section-content">
                                <div class="summary-breast-columns" style="margin-top: 12px;">
                                    <div class="summary-nested-collapse">
                                        <div class="summary-nested-title">Left Breast</div>
                                        <div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Mass</span>
                                                <span id="summary-breast-left-mass" class="summary-row-value">—</span>
                                            </div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Nipple Discharge</span>
                                                <span id="summary-breast-left-nipple" class="summary-row-value">—</span>
                                            </div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Skin Changes</span>
                                                <span id="summary-breast-left-skin" class="summary-row-value">—</span>
                                            </div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Axillary Nodes</span>
                                                <span id="summary-breast-left-axillary" class="summary-row-value">—</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="summary-nested-collapse">
                                        <div class="summary-nested-title">Right Breast</div>
                                        <div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Mass</span>
                                                <span id="summary-breast-right-mass" class="summary-row-value">—</span>
                                            </div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Nipple Discharge</span>
                                                <span id="summary-breast-right-nipple" class="summary-row-value">—</span>
                                            </div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Skin Changes</span>
                                                <span id="summary-breast-right-skin" class="summary-row-value">—</span>
                                            </div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                                <span class="summary-row-label">Axillary Nodes</span>
                                                <span id="summary-breast-right-axillary" class="summary-row-value">—</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pa-section-header" style="margin-top: 20px;">
                            <div class="pa-section-title">Pelvic Examination</div>
                        </div>
                        <div class="pa-section-content">
                                <div class="summary-nested-collapse" style="margin-top: 12px;">
                                    <div>
                                        <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                            <span class="summary-row-label">Perineum</span>
                                            <span id="summary-perinium" class="summary-row-value">—</span>
                                        </div>
                                        <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                            <span class="summary-row-label">Vagina</span>
                                            <span id="summary-vagina" class="summary-row-value">—</span>
                                        </div>
                                        <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                            <span class="summary-row-label">ADNEXA</span>
                                            <span id="summary-adnexa" class="summary-row-value">—</span>
                                        </div>
                                        <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                            <span class="summary-row-label">Cervix</span>
                                            <span id="summary-cervix" class="summary-row-value">—</span>
                                        </div>
                                        <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                            <span class="summary-row-label">Uterus</span>
                                            <span id="summary-uterus" class="summary-row-value">—</span>
                                        </div>
                                            <div class="summary-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                            <span class="summary-row-label">Uterine Depth</span>
                                            <span id="summary-uterine-depth" class="summary-row-value">—</span>
                                        </div>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="pa-summary-card large" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: 1px solid #e2e8f0; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); padding: 24px; transition: all 0.3s ease; position: relative; overflow: hidden; width: 100%;">
                        <div class="pa-collapse">
                            <div class="pa-collapse-header">
                                <div class="pa-collapse-title">Obstetrical History</div>
                                <div class="pa-collapse-icon">›</div>
                            </div>
                            <div class="pa-collapse-content">
                        <div style="display: flex; flex-direction: column; gap: 12px;">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span style="color: #475569; font-weight: 600; font-size: 14px;">Last Delivery Type</span>
                                <span id="summary-last-delivery-type" style="color: #64748b; font-size: 14px; font-weight: 600;">—</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span style="color: #475569; font-weight: 600; font-size: 14px;">Menstrual Character</span>
                                <span id="summary-menstrual-character" style="color: #64748b; font-size: 14px; font-weight: 600;">—</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span style="color: #475569; font-weight: 600; font-size: 14px;">Hydatidiform Mole (12 mos)</span>
                                <span id="summary-hydatidiform-mole" style="color: #64748b; font-size: 14px; font-weight: 600;">—</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: #f1f5f9; border-radius: 8px; border-left: 4px solid #667eea;">
                                <span style="color: #475569; font-weight: 600; font-size: 14px;">Ectopic Pregnancy</span>
                                <span id="summary-ectopic-pregnancy" style="color: #64748b; font-size: 14px; font-weight: 600;">—</span>
                            </div>
                        </div>
                            </div>
                        </div>
                    ...
                    <div class="pa-summary-card large" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: 1px solid #e2e8f0; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); padding: 24px; transition: all 0.3s ease; position: relative; overflow: hidden; width: 100%;">
                        <div class="pa-collapse">
                            <div class="pa-collapse-header">
                                <div class="pa-collapse-title">VAW Risk Assessment</div>
                                <div class="pa-collapse-icon">›</div>
                            </div>
                            <div class="pa-collapse-content">
                        <div style="display: flex; flex-direction: column; gap: 12px;">
                            ...
                            <div style="background: #f8fafc; border-radius: 8px; padding: 16px; border: 1px solid #e2e8f0;">
                                <div style="color: #475569; font-weight: 600; font-size: 14px; margin-bottom: 8px;">VAW RISK FACTORS</div>
                    ...
                    <div class="pa-summary-card large" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: 1px solid #e2e8f0; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); padding: 24px; transition: all 0.3s ease; position: relative; overflow: hidden; width: 100%;">
                        <div class="pa-collapse">
                            <div class="pa-collapse-header">
                                <div class="pa-collapse-title">Medical History</div>
                                <div class="pa-collapse-icon">›</div>
                            </div>
                            <div class="pa-collapse-content">
                                <div style="display: flex; flex-direction: column; gap: 12px;">
                            ...
                            <!-- HEENT Section -->
                            <div style="background: #f8fafc; border-radius: 8px; padding: 16px; border: 1px solid #e2e8f0;">
                                <div style="color: #475569; font-weight: 600; font-size: 14px; margin-bottom: 8px;"> HEENT (Head, Eyes, Ears, Nose, Throat)</div>
                                <div style="display: flex; flex-direction: column; gap: 8px;">
                                    <div style="display: flex; justify-content: space-between; align-items: flex-start; padding: 8px 12px; background: #f1f5f9; border-radius: 6px; border-left: 3px solid #667eea;">
                            ...
                            <!-- STI Risks Section -->
                            <div style="background: #f8fafc; border-radius: 8px; padding: 16px; border: 1px solid #e2e8f0;">
                                <div style="color: #475569; font-weight: 600; font-size: 14px; margin-bottom: 8px;">STI RISKS</div>
                                <div style="display: flex; flex-direction: column; gap: 8px;">
                                    <div style="display: flex; justify-content: space-between; align-items: flex-start; padding: 8px 12px; background: #f1f5f9; border-radius: 6px; border-left: 3px solid #667eea;">
                                        <span style="color: #475569; font-weight: 500; font-size: 13px;">Multiple Partners</span>
    ...
    <div id="visitAnalyticsModal" class="modal-overlay" style="display:none; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0, 0, 0, 0.6); backdrop-filter: blur(8px); z-index: 9999; align-items: center; justify-content: center;">
      <div class="modal-content" style="max-width: 800px; width: 95%; background: #ffffff; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(0, 0, 0, 0.05); border-radius: 24px; padding: 0; overflow: hidden; max-height: 90vh; min-height: 500px; position: relative; display: flex; flex-direction: column;">
        ...
        <div class="pa-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 32px 40px 24px 40px; position: relative; overflow: hidden; flex-shrink: 0;">
    ...
    <div id="physicalExamModal" class="modal-overlay" style="display:none; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0, 0, 0, 0.6); backdrop-filter: blur(8px); z-index: 9999; align-items: center; justify-content: center;">
      <div class="modal-content" style="max-width: 800px; width: 95%; background: #ffffff; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(0, 0, 0, 0.05); border-radius: 24px; padding: 0; overflow: hidden; max-height: 90vh; min-height: 500px; position: relative; display: flex; flex-direction: column;">
        ...
        <!-- Enhanced Form -->
        <form id="physicalExamForm" class="pa-form"  style="padding: 40px; background: linear-gradient(180deg, #fafbfc 0%, #ffffff 100%); overflow-y: auto; flex: 1; scrollbar-width: thin; scrollbar-color: #cbd5e1 #f1f5f9;">
        ...
        <div id="physicalExamPage1">
            ...
            <!-- Tab Navigation -->
            <div class="pa-tabs" style="display: flex; gap: 8px; margin-bottom: 32px; border-bottom: 2px solid #e2e8f0; padding-bottom: 0;">
            ...
            <div id="physical-examination-content" class="tab-content active pa-content">
            <!-- Physical Examination Section -->
            <div style="margin-bottom: 24px;">
              <input  name="patient_id" type="hidden" value="<?= htmlspecialchars(PatientRecord::$id) ?>">
              <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">Physical Examination</h3>
              
              <div class="pa-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                  <input type="hidden" name="staff_id" value="<?= htmlspecialchars($_SESSION['user_id'] ?? 0) ?>">
                  <!-- Doctor's Note moved below tab -->
                

                <div class="pa-card" style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0;">
                  <span style="color: #1e293b; font-weight: 600; font-size: 14px; display: block; margin-bottom: 12px;">Conjunctiva</span>
            ...
            <div style="margin-bottom: 24px;">
              <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">Pelvic Examination</h3>
              ...
              <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0;">
                  ...
                  <span style="color: #1e293b; font-weight: 500; display: block; margin: 12px 0 8px 0; font-size: 13px;">Consistency:</span>
                    <select name="cervix_consistency" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 2px solid #e2e8f0; font-size: 15px; background: #ffffff; transition: all 0.3s ease; box-shadow: inset 0 1px 3px rgba(0,0,0,0.06);">
                ...
                <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0;">
                  ...
                  <span style="color: #1e293b; font-weight: 500; display: block; margin: 12px 0 8px 0; font-size: 13px;">Position:</span>
                    <select name="uterus_position" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 2px solid #e2e8f0; font-size: 15px; background: #ffffff; transition: all 0.3s ease; box-shadow: inset 0 1px 3px rgba(0,0,0,0.06);">
                      <option value="">--Select--</option>
                  ...
                  <span style="color: #1e293b; font-weight: 500; display: block; margin: 12px 0 8px 0; font-size: 13px;">Size:</span>
                    <select name="uterus_size" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 2px solid #e2e8f0; font-size: 15px; background: #ffffff; transition: all 0.3s ease; box-shadow: inset 0 1px 3px rgba(0,0,0,0.06);">
                      <option value="">--Select--</option>
            ...
            <!-- Doctor's Note Section - Separated from Pelvic Examination -->
            <div style="margin-bottom: 24px;">
              <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0;">
                <span style="color: #1e293b; font-weight: 600; font-size: 14px; display: block; margin-bottom: 12px;">Doctor's Note</span>
                <input type="text" name="doctor_note" id="doctor_note_physical" placeholder="Enter summary or remarks here..." style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 14px; background: #ffffff;">
              </div>
            </div>
          </div>
          ...
          <div id="medical-history-content" class="tab-content pa-content" style="display: none;">
            <!-- HEENT Section --> 
            ...
            <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
              <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">HEENT</h3>
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div>
            ...
            <!-- CHEST/HEART Section -->
            <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
              <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">CHEST/HEART</h3>
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div>
                  <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; margin-bottom: 12px; color: #475569;">
             ...
             <!-- ABDOMEN Section -->
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
               <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">ABDOMEN</h3>
               <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                 <div>
                   <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; margin-bottom: 12px; color: #475569;">
             ...
             <!-- GENITAL Section -->
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
               <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">GENITAL</h3>
               <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                 <div>
                   <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; margin-bottom: 12px; color: #475569;">
             ...
             <!-- EXTREMITIES Section -->
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
               <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">EXTREMITIES</h3>
               <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                 <div>
                   <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; margin-bottom: 12px; color: #475569;">
             ...
             <!-- SKIN Section -->
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
               <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">SKIN</h3>
               <div>
                 <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; margin-bottom: 12px; color: #475569;">
             ...
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
               <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">HISTORY OF THE FOLLOWING</h3>
               <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                 <div>
                   <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; margin-bottom: 12px; color: #475569;">
            ...
            <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
              <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">STI RISKS</h3>
              ...
              <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-top: 8px;">
                <span style="color: #1e293b; font-weight: 600; font-size: 14px; display: block; margin-bottom: 12px;">Doctor's Note</span>
                <input type="text" name="doctor_note" id="doctor_note_medical" placeholder="Enter summary or remarks here..." style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 14px; background: #ffffff;">
              </div>
            </form>
             </div>
           ...
           <div id="obstetrical-history-content" class="tab-content pa-content" style="display: none;">
           ...
           <!-- NUMBER OF PREGNANCIES Section -->
            ...
            <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
             ...
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-top: 8px;">
                <span style="color: #1e293b; font-weight: 600; font-size: 14px; display: block; margin-bottom: 12px;">Doctor's Note</span>
                <input type="text" name="doctor_note" id="doctor_note_obstetrical" placeholder="Enter summary or remarks here..." style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 14px; background: #ffffff;">
              </div>
              <!-- Auto-save enabled: removed manual Save button -->
            </form>
           </div>
           ...
           <div id="vaw-risk-content" class="tab-content pa-content" style="display: none;">
             <!-- VAW Risk Assessment -->
            ...
            <input  name="patient_id" value="<?= htmlspecialchars(PatientRecord::$id) ?>" type="hidden">
             ...
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
              <h3 style="color: #1e293b; font-weight: 700; font-size: 18px; margin-bottom: 20px; display: flex; align-items: center; gap: 8px;">RISK FOR VIOLENCE AGAINST WOMEN (VAW)</h3>
               <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                 <div>
                   <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; margin-bottom: 12px; color: #475569;">
             ...
             <div style="background: #f8fafc; border-radius: 12px; padding: 24px; border: 1px solid #e2e8f0; margin-top: 8px;">
                <span style="color: #1e293b; font-weight: 600; font-size: 14px; display: block; margin-bottom: 12px;">Doctor's Note</span>
                <input type="text" name="doctor_note" id="doctor_note_vaw" placeholder="Enter summary or remarks here..." style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 14px; background: #ffffff;">
              </div>
              <!-- Auto-save enabled: removed manual Save button -->
           </div>
           </form>
...
var vawSubmitEl = document.getElementById('submit-vaw-btn');
if (vawSubmitEl) vawSubmitEl.addEventListener('click', function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const setupAutoSave = (formId, url) => {
  ...
  setupAutoSave('physicalExamForm', 'auth/action/submit_physical_exam_record.php');
  setupAutoSave('medicalHistoryForm', 'auth/action/submit_medical_history.php');
  setupAutoSave('obstetricalHistoryForm', 'auth/action/submit_obstetrical_history.php');
  setupAutoSave('vaw-risk-form', 'auth/action/submit_vaw_risk_assessment.php');
  const vawBtn = document.getElementById('submit-vaw-btn');
  if (vawBtn) {
    vawBtn.addEventListener('click', (e) => e.preventDefault());
  }
});
    ...
    fetch(`auth/action/staff/staff_get_latest_obstetrical_history.php?patient_id=${encodeURIComponent(patientId)}`)
        ...
        .then(result => {
            if (result.status === 'success' && result.data) {
                ...
                updateSummaryCard('summary-last-delivery-type', data.last_delivery_type);
                updateSummaryCard('summary-menstrual-character', data.menstrual_character);
                updateSummaryCard('summary-hydatidiform-mole', data.hydatidiform_mole ? 'Yes' : 'No');
                updateSummaryCard('summary-ectopic-pregnancy', data.ectopic_pregnancy ? 'Yes' : 'No');
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll(".pa-collapse-header").forEach(header => {
        header.addEventListener("click", () => {
            header.parentElement.classList.toggle("open");
        });
    });
    const summaryEl = document.getElementById('physicalExamContent');
    const summaryLayoutSelect = document.getElementById('summaryLayoutSelect');
    const modalLayoutSelect = document.getElementById('modalLayoutSelect');
    if (summaryLayoutSelect) {
        summaryLayoutSelect.addEventListener('change', function() {
            if (this.value === 'chips') {
                summaryEl.classList.add('pa-layout-chips');
                summaryEl.classList.remove('pa-layout-cards');
            } else {
                summaryEl.classList.remove('pa-layout-chips');
                summaryEl.classList.add('pa-layout-cards');
            }
        });
    }
    if (modalLayoutSelect) {
        modalLayoutSelect.addEventListener('change', function() {
            const modalContent = document.querySelector('#physicalExamModal .modal-content');
            if (!modalContent) return;
            if (this.value === 'compact') {
                modalContent.classList.add('modal-layout-compact');
            } else {
                modalContent.classList.remove('modal-layout-compact');
            }
        });
    }
});
